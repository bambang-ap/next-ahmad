			...
			{!!id_customer && (
				<div className="flex flex-col gap-2">
					{listPO?.map((po, i) => {
						...
						return (
							<>
								<div className="my-2 bg-gray-500 p-0.5" />
								<div key={poKey} className="px-2 flex flex-col gap-2">
																		...
																		<>
																			...
																			<Cell className="flex gap-2">
																				{qtyMap(({qtyKey, unitKey, num}) => {
																					...
																					const qtyRejectRP =
																						rejectedItems?.[id_item]?.RP?.[
																							qtyKey
																						];
																					const qtyRejectTP =
																						rejectedItems?.[id_item]?.TP?.[
																							qtyKey
																						];
																					const qtyRejectSC =
																						rejectedItems?.[id_item]?.SC?.[
																							qtyKey
																						];
