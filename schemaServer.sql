...
CREATE TABLE
    public.inv_supplier_item_relation (
        id character varying(47) NOT NULL,
...
ALTER TABLE
    ONLY public.customer_sppb_out_item
ADD
    CONSTRAINT customer_sppb_out_item_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.inv_supplier_po_item
ADD
    CONSTRAINT inv_supplier_po_item_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.inv_supplier_item_relation
ADD
    CONSTRAINT supplier_item_relation_pkey PRIMARY KEY (id);
...
CREATE INDEX
    createdby_1693939331115_index ON public.kanban USING btree ("createdBy");
...
CREATE INDEX
    "customer_sppb_in_createdAt_index" ON public.customer_sppb_in USING btree ("createdAt" DESC);
...
CREATE INDEX
    customer_sppb_in_id_po_index ON public.customer_sppb_in USING btree (id_po);
...
CREATE INDEX
    customer_sppb_in_id_po_index2 ON public.customer_sppb_in USING btree (id_po);
...
CREATE INDEX
    customer_sppb_in_id_po_index3 ON public.customer_sppb_in USING btree (id_po) INCLUDE (nomor_surat, "createdAt", tgl);
...
CREATE INDEX
    customer_sppb_in_nomor_surat_index ON public.customer_sppb_in USING btree (nomor_surat);
...
CREATE INDEX
    customer_sppb_in_tgl_index ON public.customer_sppb_in USING btree (tgl);
...
CREATE INDEX
    doc_id_1693939147464_index ON public.kanban USING btree (doc_id);
...
CREATE INDEX
    email_1693939633648_index ON public.user_pengguna USING btree (email);
...
CREATE INDEX
    id_1693939527547_index ON public.customer USING btree (id);
...
CREATE INDEX
    id_customer_1693938989246_index ON public.po USING btree (id_customer);
...
CREATE INDEX
    id_customer_1693939019302_index ON public.customer_sppb_out USING btree (id_customer);
...
CREATE INDEX
    id_kanban_1693939108665_index ON public.kanban_item USING btree (id_kanban);
...
CREATE INDEX
    id_kanban_1693939168149_index ON public.scan USING btree (id_kanban);
...
CREATE INDEX
    id_kategori_1693939411214_index ON public.hardness USING btree (id_kategori);
...
CREATE INDEX
    id_kategori_1693939423366_index ON public.material USING btree (id_kategori);
...
CREATE INDEX
    id_kategori_1693939433148_index ON public.parameter USING btree (id_kategori);
...
CREATE INDEX
    id_kendaraan_1693939024312_index ON public.customer_sppb_out USING btree (id_kendaraan);
...
CREATE INDEX
    id_po_1693939039051_index ON public.kanban USING btree (id_po);
...
CREATE INDEX
    id_po_1693939054565_index ON public.po_itemm USING btree (id_po);
...
CREATE INDEX
    id_po_1693939296738_index ON public.customer_sppb_in USING btree (id_po);
...
CREATE INDEX
    id_po_1693939397429_index ON public.inv_supplier_po_item USING btree (id_po);
...
CREATE INDEX
    id_sppb_in_1693939092480_index ON public.po_item_sppb_in USING btree (id_sppb_in);
...
CREATE INDEX
    id_sppb_in_1693939278930_index ON public.kanban USING btree (id_sppb_in);
...
CREATE INDEX
    id_supplier_item_1693939377317_index ON public.inv_supplier_po_item USING btree (id_supplier_item);
...
CREATE INDEX
    item_id_1693939461883_index ON public.inv_supplier_item_relation USING btree (item_id);
...
CREATE INDEX
    "kanban_item_createdAt_index" ON public.kanban_item USING btree ("createdAt" DESC);
...
CREATE INDEX
    kanban_item_id_item_index ON public.kanban_item USING btree (id_item);
...
CREATE INDEX
    kategori_mesin_1693938962084_index ON public.master_item USING btree (kategori_mesin);
...
CREATE INDEX
    kategori_mesin_1693938980082_index ON public.mesin USING btree (kategori_mesin);
...
CREATE INDEX
    master_item_id_1693938881549_index ON public.po_itemm USING btree (master_item_id);
...
CREATE INDEX
    master_item_id_1693938902665_index ON public.kanban_item USING btree (master_item_id);
...
CREATE INDEX
    master_item_id_1693938923669_index ON public.po_item_sppb_in USING btree (master_item_id);
...
CREATE INDEX
    password_1693939643811_index ON public.user_pengguna USING btree (password);
...
CREATE INDEX
    "po_item_sppb_in_createdAt_index" ON public.po_item_sppb_in USING btree ("createdAt" DESC);
...
CREATE INDEX
    status_finish_good_1693939711768_index ON public.scan USING btree (status_finish_good);
...
CREATE INDEX
    status_produksi_1693939711768_index ON public.scan USING btree (status_produksi);
...
CREATE INDEX
    status_qc_1693939711768_index ON public.scan USING btree (status_qc);
...
CREATE INDEX
    supplier_id_1693939467378_index ON public.inv_supplier_item_relation USING btree (supplier_id);
...
CREATE INDEX
    updatedby_1693939331115_index ON public.kanban USING btree ("updatedBy");
...
ALTER TABLE
    ONLY public.inv_supplier_po_item
ADD
    CONSTRAINT inv_supplier_po_item_id_po_fkey FOREIGN KEY (id_po) REFERENCES public.inv_supplier_po(id);
...
ALTER TABLE
    ONLY public.inv_supplier_po_item
ADD
    CONSTRAINT inv_supplier_po_item_id_supplier_item_fkey FOREIGN KEY (id_supplier_item) REFERENCES public.inv_supplier_item_relation(id);
...
ALTER TABLE
    ONLY public.inv_supplier_item_relation
ADD
    CONSTRAINT item_id FOREIGN KEY (item_id) REFERENCES public.inv_supplier_item(id);
...
ALTER TABLE
    ONLY public.inv_supplier_item_relation
ADD
    CONSTRAINT supplier_id FOREIGN KEY (supplier_id) REFERENCES public.inv_supplier(id);
