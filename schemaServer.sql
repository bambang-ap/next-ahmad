...
CREATE TABLE public_temp.customer (
    id character varying(47) NOT NULL,
    name character varying(100) NOT NULL,
    "createdAt" timestamp without time zone,
    "updatedAt" timestamp without time zone,
...
CREATE TABLE public_temp.customer_sppb_in (
    id character varying(47) NOT NULL,
    nomor_surat character varying(100) NOT NULL,
    "createdAt" timestamp without time zone,
    "updatedAt" timestamp without time zone,
...
CREATE TABLE public_temp.customer_sppb_out (
    id character varying(47) NOT NULL,
    id_customer character varying(47) NOT NULL,
    "createdAt" timestamp without time zone,
    "updatedAt" timestamp without time zone,
...
CREATE TABLE public_temp.document_number (
    id character varying(47) NOT NULL,
    doc_no character varying(100) NOT NULL,
    keterangan character varying(255) NOT NULL,
    "createdAt" timestamp without time zone,
...
CREATE TABLE public_temp.hardness (
    id character varying(47) NOT NULL,
    id_kategori character varying(47) NOT NULL,
    name character varying(100) NOT NULL,
    "createdAt" timestamp without time zone,
...
CREATE TABLE public_temp.hardness_kategori (
    id character varying(47) NOT NULL,
    name character varying(100) NOT NULL,
    "createdAt" timestamp without time zone,
    "updatedAt" timestamp without time zone
...
CREATE TABLE public_temp.instruksi_kanban (
    id character varying(47) NOT NULL,
    name character varying(100) NOT NULL,
    "createdAt" timestamp without time zone,
    "updatedAt" timestamp without time zone
...
CREATE TABLE public_temp.kanban (
    id character varying(47) NOT NULL,
    id_po character varying(47),
    "createdAt" timestamp without time zone,
    "updatedAt" timestamp without time zone,
...
CREATE TABLE public_temp.kanban_item (
    id character varying(47) NOT NULL,
    id_item character varying(47) NOT NULL,
    id_kanban character varying(47) NOT NULL,
    qty1 numeric,
...
CREATE TABLE public_temp.kendaraan (
    id character varying(47) NOT NULL,
    name character varying(100) NOT NULL,
    "createdAt" timestamp without time zone,
    "updatedAt" timestamp without time zone
...
CREATE TABLE public_temp.master_item (
    id character varying(47) NOT NULL,
    name character varying(255),
    kode_item character varying(255),
    "createdAt" timestamp without time zone,
...
CREATE TABLE public_temp.material (
    id character varying(47) NOT NULL,
    id_kategori character varying(47) NOT NULL,
    name character varying(100) NOT NULL,
    "createdAt" timestamp without time zone,
...
CREATE TABLE public_temp.material_kategori (
    id character varying(47) NOT NULL,
    name character varying(100) NOT NULL,
    "createdAt" timestamp without time zone,
    "updatedAt" timestamp without time zone
...
CREATE TABLE public_temp.mesin (
    id character varying(47) NOT NULL,
    nomor_mesin character varying(50) NOT NULL,
    name character varying(100),
    "createdAt" timestamp without time zone,
...
CREATE TABLE public_temp.mesin_kategori (
    id character varying(47) NOT NULL,
    name character varying(100) NOT NULL,
    "createdAt" timestamp without time zone,
    "updatedAt" timestamp without time zone
...
CREATE TABLE public_temp.parameter (
    id character varying(47) NOT NULL,
    id_kategori character varying(47) NOT NULL,
    name character varying(100) NOT NULL,
    "createdAt" timestamp without time zone,
...
CREATE TABLE public_temp.parameter_kategori (
    id character varying(47) NOT NULL,
    name character varying(100) NOT NULL,
    "createdAt" timestamp without time zone,
    "updatedAt" timestamp without time zone
...
CREATE TABLE public_temp.po_item_sppb_in (
    id character varying(47) NOT NULL,
    id_item character varying(47) NOT NULL,
    id_sppb_in character varying(47) NOT NULL,
    qty1 numeric,
...
CREATE TABLE public_temp.po_itemm (
    id character varying(47) NOT NULL,
    qty1 numeric,
    unit1 character varying(25),
    qty2 numeric,
...
CREATE TABLE public_temp.supplier (
    id character varying(47) NOT NULL,
    name character varying(100) NOT NULL,
    "createdAt" timestamp without time zone,
    "updatedAt" timestamp without time zone
...
CREATE TABLE public_temp.supplier_item (
    id character varying(47) NOT NULL,
    id_supplier character varying(47) NOT NULL,
    code_item character varying(100) NOT NULL,
    name_item character varying(100) NOT NULL,
...
CREATE TABLE public_temp.supplier_po (
    id character varying(47) NOT NULL,
    id_supplier character varying(47) NOT NULL,
    items json DEFAULT '{}'::json,
    "createdAt" timestamp without time zone,
...
CREATE TABLE public_temp.user_login (
    id character varying(47) NOT NULL,
    id_user character varying(100) NOT NULL,
    "expiredAt" timestamp without time zone,
    "createdAt" timestamp without time zone,
...
CREATE TABLE public_temp.user_pengguna (
    id character varying(47) NOT NULL,
    email character varying(50) NOT NULL,
    name character varying(100) NOT NULL,
    password character varying(100) NOT NULL,
...
ALTER TABLE ONLY public_temp.user_login
    ADD CONSTRAINT customer_login_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.customer
    ADD CONSTRAINT customer_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.customer_sppb_in
    ADD CONSTRAINT customer_sppb_in_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.document_number
    ADD CONSTRAINT document_number_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.hardness_kategori
    ADD CONSTRAINT hardness_kategori_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.hardness
    ADD CONSTRAINT hardness_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.user_pengguna
    ADD CONSTRAINT id_pkey PRIMARY KEY (id) INCLUDE (id);
...
ALTER TABLE ONLY public_temp.instruksi_kanban
    ADD CONSTRAINT instruksi_kanban_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.kanban_item
    ADD CONSTRAINT kanban_item_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.kanban
    ADD CONSTRAINT kanban_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.material_kategori
    ADD CONSTRAINT kategori_material_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.kendaraan
    ADD CONSTRAINT kendaraan_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.master_item
    ADD CONSTRAINT master_item_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.material
    ADD CONSTRAINT material_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.menu
    ADD CONSTRAINT menu_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.mesin_kategori
    ADD CONSTRAINT mesin_kategori_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.mesin
    ADD CONSTRAINT mesin_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.parameter_kategori
    ADD CONSTRAINT parameter_kategori_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.parameter
    ADD CONSTRAINT parameter_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.po_item_sppb_in
    ADD CONSTRAINT po_item_sppb_in_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.po_itemm
    ADD CONSTRAINT po_itemm_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.role
    ADD CONSTRAINT role_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.scan
    ADD CONSTRAINT scan_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.customer_sppb_out
    ADD CONSTRAINT sppb_out_pk PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.supplier_item
    ADD CONSTRAINT supplier_item_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.supplier
    ADD CONSTRAINT supplier_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.supplier_po
    ADD CONSTRAINT supplier_po_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public_temp.customer_sppb_in
    ADD CONSTRAINT customer_sppb_in_id_po_fkey FOREIGN KEY (id_po) REFERENCES public_temp.po(id);
...
ALTER TABLE ONLY public_temp.hardness
    ADD CONSTRAINT hardness_id_kategori_fkey FOREIGN KEY (id_kategori) REFERENCES public_temp.hardness_kategori(id);
...
ALTER TABLE ONLY public_temp.scan
    ADD CONSTRAINT id_kanban FOREIGN KEY (id_kanban) REFERENCES public_temp.kanban(id);
...
ALTER TABLE ONLY public_temp.kanban
    ADD CONSTRAINT kanban_doc_id_fkey FOREIGN KEY (doc_id) REFERENCES public_temp.document_number(id);
...
ALTER TABLE ONLY public_temp.kanban
    ADD CONSTRAINT kanban_id_po_fkey FOREIGN KEY (id_po) REFERENCES public_temp.po(id);
...
ALTER TABLE ONLY public_temp.kanban_item
    ADD CONSTRAINT kanban_item_id_item_fkey FOREIGN KEY (id_item) REFERENCES public_temp.po_item_sppb_in(id);
...
ALTER TABLE ONLY public_temp.kanban_item
    ADD CONSTRAINT kanban_item_id_kanban_fkey FOREIGN KEY (id_kanban) REFERENCES public_temp.kanban(id);
...
ALTER TABLE ONLY public_temp.material
    ADD CONSTRAINT material_id_kategori_fkey FOREIGN KEY (id_kategori) REFERENCES public_temp.material_kategori(id);
...
ALTER TABLE ONLY public_temp.mesin
    ADD CONSTRAINT mesin_kategori_mesin_fkey FOREIGN KEY (kategori_mesin) REFERENCES public_temp.mesin_kategori(id);
...
ALTER TABLE ONLY public_temp.parameter
    ADD CONSTRAINT parameter_id_kategori_fkey FOREIGN KEY (id_kategori) REFERENCES public_temp.parameter_kategori(id);
...
ALTER TABLE ONLY public_temp.po_item_sppb_in
    ADD CONSTRAINT po_item_sppb_in_id_item_fkey FOREIGN KEY (id_item) REFERENCES public_temp.po_itemm(id);
...
ALTER TABLE ONLY public_temp.po_item_sppb_in
    ADD CONSTRAINT po_item_sppb_in_id_sppb_in_fkey FOREIGN KEY (id_sppb_in) REFERENCES public_temp.customer_sppb_in(id);
...
ALTER TABLE ONLY public_temp.po_itemm
    ADD CONSTRAINT po_itemm_id_po_fkey FOREIGN KEY (id_po) REFERENCES public_temp.po(id);
...
ALTER TABLE ONLY public_temp.user_login
    ADD CONSTRAINT user_login_id_user_fkey FOREIGN KEY (id_user) REFERENCES public_temp.user_pengguna(id);
...
ALTER TABLE ONLY public_temp.user_pengguna
    ADD CONSTRAINT user_role_fkey FOREIGN KEY (role) REFERENCES public_temp.role(id) NOT VALID;
